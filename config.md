...
Ports in use: `5432` (Postgres), `27017` (MongoDB), `6379` (Redis), `7687` + `7474` (Neo4j).
...
- switch to SSH tunneling in DataGrip's SSH/SSL tab instead of exposing DB ports directly.# Database Server Config Reference
